...
public class PokemonShape implements PokeApiResource, Localizable {
    ...
    private List<AwesomeName> awsome_names;
    ...
    public List<AwesomeName> getAwsome_names() {
        return awsome_names;
    }

    public void setAwsome_names(List<AwesomeName> awsome_names) {
        this.awsome_names = awsome_names;
    }
